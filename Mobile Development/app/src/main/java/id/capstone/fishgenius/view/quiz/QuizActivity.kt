...
import id.capstone.fishgenius.data.remote.response.QuizModule
import id.capstone.fishgenius.data.remote.response.SoalData
import id.capstone.fishgenius.databinding.ActivityQuizBinding
import id.capstone.fishgenius.databinding.CustomAlertApiBinding
import id.capstone.fishgenius.databinding.CustomAlertScoreBinding
import id.capstone.fishgenius.view.ViewModelFactory
import id.capstone.fishgenius.view.classfinished.ClassFinishedActivity
...
class QuizActivity : AppCompatActivity() {
    ...
    private var statusQuiz: Boolean = false
