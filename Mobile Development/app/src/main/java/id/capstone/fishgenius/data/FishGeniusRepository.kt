package id.capstone.fishgenius.data
...
import id.capstone.fishgenius.data.remote.response.*
import id.capstone.fishgenius.data.remote.retrofit.ServicesAPI
...
class FishGeniusRepository(
    private val fishGeniusRoomDatabase: FishGeniusRoomDatabase,
            ...
            override fun onResponse(call: Call<AllClassesResponse>, response: Response<AllClassesResponse>) {
                if(response.isSuccessful){
                    ...
                    runBlocking {
                        ...
                        fishGeniusRoomDatabase.fishgeniusDao().deleteAllClasses()
                       fishGeniusRoomDatabase.fishgeniusDao().insertClasses(classesList)
                    }
    ...
    fun getSearchClass(word: String): LiveData<List<Classes>>{
        return fishGeniusRoomDatabase.fishgeniusDao().searchClasses(word)
    }
