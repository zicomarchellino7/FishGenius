...
import id.capstone.fishgenius.data.remote.response.ListModuleData
import id.capstone.fishgenius.databinding.ViewholderClassDetailSilabusBinding
import id.capstone.fishgenius.view.classmodule.ClassModuleActivity
import id.capstone.fishgenius.view.classmodule.ClassModuleActivity.Companion.CLASS_TITLE_EXTRA
import id.capstone.fishgenius.view.classmodule.ClassModuleActivity.Companion.ID_CLASS_EXTRA
import id.capstone.fishgenius.view.classmodule.ClassModuleActivity.Companion.ID_MODULE_EXTRA
import id.capstone.fishgenius.view.quiz.QuizActivity
