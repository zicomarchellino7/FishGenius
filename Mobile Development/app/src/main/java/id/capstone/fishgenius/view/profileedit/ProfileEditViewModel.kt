...
class ProfileEditViewModel(private val fishGeniusRepository: FishGeniusRepository): ViewModel() {
    ...
    fun editProfile(profilePictureMultipart: MultipartBody.Part?, userid: RequestBody, name: RequestBody,age:RequestBody, address: RequestBody) = fishGeniusRepository.editProfile(profilePictureMultipart,name,age,address,userid)
