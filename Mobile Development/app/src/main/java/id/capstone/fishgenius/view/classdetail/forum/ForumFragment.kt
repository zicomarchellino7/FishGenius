...
import id.capstone.fishgenius.databinding.FragmentForumBinding
                ...
                liveData.observe(requireActivity()) { result ->
                    if (result != null) {
                        when (result) {
                            ...
                            is Result.Success -> {
                                binding.rvListForum.visibility = View.VISIBLE
                                ...
                                if (result.data.data != null) {
                                    ...
                                    binding.rvListForum.visibility = View.INVISIBLE
