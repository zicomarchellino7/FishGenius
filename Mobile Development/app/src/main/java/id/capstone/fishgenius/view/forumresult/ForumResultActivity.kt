...
import id.capstone.fishgenius.data.remote.response.DataItem
import id.capstone.fishgenius.data.remote.response.ListForumItem
import id.capstone.fishgenius.databinding.ActivityForumResultBinding
...
class ForumResultActivity : AppCompatActivity() {
    ...
    private val textWatcher: TextWatcher = object : TextWatcher {
        ...
        override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
            ...
            if(msg.isNotEmpty()){
                binding.buttonGchatSend.setTextColor(application.resources.getColor(R.color.light_blue_600,null))
            }else{
